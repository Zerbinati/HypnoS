...
// Initialization of FileBB: each file represented as a bitboard
Bitboard FileBB[8] = {
...
Bitboard adjacent_files_bb(File f) {
    return (f == FILE_A ? FileBB[FILE_B] :           // Colonna A ha solo B adiacente
            f == FILE_H ? FileBB[FILE_G] :           // Colonna H ha solo G adiacente
            FileBB[f - 1] | FileBB[f + 1]);          // Colonne centrali hanno entrambi adiacenti
}
