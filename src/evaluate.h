...
// Declaration of the compute_phase_coeff function
double compute_phase_coeff(int totalMaterial);

// Declarations of new functions added in evaluate.cpp
...
// Declarations for evaluation functions
Value evaluate(const Position& pos);
std::string trace(Position& pos);

// Declaration of the simple evaluation function
